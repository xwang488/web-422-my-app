...
export default function Register (props) {
    ...
    async function handleSubmit (e) {
        ...
        await registerUser(userName, password, password2).then(async () => {
    ...
    return (
        <>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <br />
                <Form.Group>
                    <Form.Label>Password:</Form.Label><Form.Control value={password2} onChange={e => setPassword2(e.target.value)} type="password" id="password" name="password" />
                </Form.Group>
                <br />
